...
/**
 * Ambient floating logo glyphs — a fixed, non-interactive background layer
 * (Copilot-style): above the page background, behind all content, never
 * clipped by section overflow. Glyph-only (no card box / label).
 * pointer-events-none so content stays clickable. Hidden on small screens.
 */
