...
export function Pricing() {
  return (
    <section id="pricing" className="scroll-fade-in relative px-5 py-24 md:px-8">
      ...
      <div className="relative mx-auto mt-12 max-w-md">
        <div className="rounded-3xl border border-violet/30 bg-surface/80 p-8 shadow-[0_40px_100px_-40px_rgba(59,130,246,0.35)] backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-violet/60 hover:shadow-[0_48px_120px_-40px_rgba(59,130,246,0.45)]">
