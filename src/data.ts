...
export const ecosystem = [
  {
    ...
    logo: "/logos/logo-revit.png",
  },
  {
    label: "AutoCAD",
    glyph: "Ac",
    tint: "linear-gradient(135deg,#e04b4b,#8a1f1f)",
    logo: "/logos/logo-autocad.png",
  },
  {
    label: "QGIS",
    glyph: "Qg",
    tint: "linear-gradient(135deg,#3ec46d,#1f7a45)",
    logo: "/logos/logo-qgis.png",
  },
  {
    label: "ArcGIS",
    glyph: "Ag",
    tint: "linear-gradient(135deg,#4b7bec,#26408b)",
    logo: "/logos/logo-arcgis.png",
  },
  {
    label: "SketchUp",
    glyph: "Sk",
    tint: "linear-gradient(135deg,#f5a623,#b5730a)",
    logo: "/logos/logo-sketchup.png",
  },
  {
    label: "SAP2000",
    glyph: "Sp",
    tint: "linear-gradient(135deg,#7c5cff,#472fa8)",
    logo: "/logos/logo-sap.png",
  },
  {
    label: "Metashape",
    glyph: "Ms",
    tint: "linear-gradient(135deg,#26c6da,#0d7d8c)",
    logo: "/logos/logo-metashape.png",
  },
  {
    label: "MS Project",
    glyph: "Of",
    tint: "linear-gradient(135deg,#e8663a,#a33d1a)",
    logo: "/logos/logo-msproject.png",
  },
  {
    label: "Abaqus",
    glyph: "Ab",
    tint: "linear-gradient(135deg,#607d8b,#37474f)",
    logo: "/logos/logo-abaqus.png",
  },
]
